"""
Django settings for kuvatest_project project.
...
SECRET_KEY = '&qp$&3*mcm2o9a__g3@=50h$-eh&+e%7j1_65)n9ar&s_4*q)#'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', 'zerodepth.jatu.online']
...
ROOT_URLCONF = 'kuvatest_project.urls'
...
WSGI_APPLICATION = 'kuvatest_project.wsgi.application'
